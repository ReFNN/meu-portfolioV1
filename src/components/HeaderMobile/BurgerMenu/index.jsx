...
export default function BurgerMenu({ actRoute }) {
    const activeRoute = actRoute;
    const [isOpen, setIsOpen] = useState(false);

    function handlerMenu() {
        setIsOpen(!isOpen);
        const btnToggle = document.querySelector('#blackBGID');
        if (btnToggle.classList.contains('is-opened')) {
    ...
    return (
        <>
            <nav className='containerBurguer'>
                <div className='toggleMenu' onClick={handlerMenu}>
                    {isOpen === false ? (
                        <svg
